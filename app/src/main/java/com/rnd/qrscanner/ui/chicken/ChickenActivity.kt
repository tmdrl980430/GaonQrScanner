package com.rnd.qrscanner.ui.chicken
...
import com.rnd.qrscanner.databinding.ActivityChickenBinding
...
class ChickenActivity: BaseActivity<ActivityChickenBinding>(ActivityChickenBinding::inflate) , MainView{
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(json.getInt("mealTypeIdx") == 9) {
            ...
            handler.postDelayed(Runnable {
                startActivityWithClear(ChickenActivity::class.java)
            }, 3000) //딜레이 타임 조절
        }
